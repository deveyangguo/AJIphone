//
//  RTADataCompanyDetailViewController.m
//  AJIphone
//
...
@interface RTADataCompanyDetailViewController ()

@end

@implementation RTADataCompanyDetailViewController
...
//	RealTimeAlarmInfo *info = [records objectAtIndex:section];
//	return [info.companyName stringByAppendingFormat:@"%@%@",@" — ",info.mineName];
//}
...
//    RTADataCompanyDetailCustomCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];  
