...
@implementation SoapNSXMLParserGroupDetail
...
- (void)getOffesetUTCTimeSOAP
{
	...
	NSString *soapMessage = [NSString stringWithFormat:
							 ...
							 "<soap:Body>\n"
							 "<GetRealTimeAlarmInfoBySenTypeId xmlns=\"http://thinkcore.net/webservices/\">\n"
                             "<senTypeId>%@</senTypeId>\n"
							 "</GetRealTimeAlarmInfoBySenTypeId>\n"
							 "</soap:Body>\n"
							 "</soap:Envelope>\n",senTypeId
							 ];
	//NSLog(@"%@",soapMessage);
	...
	[theRequest addValue: @"http://thinkcore.net/webservices/GetRealTimeAlarmInfoBySenTypeId" forHTTPHeaderField:@"SOAPAction"];
